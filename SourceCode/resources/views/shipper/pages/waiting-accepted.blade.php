...
@section('controller', 'Đơn hàng chờ xác nhận')
        ...
        <div class="col-md-push-0 col-md-12">
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody align="center">
                    ...
                    @else
                        <tr>
                            <td class="text-center" colspan="{{ 8 }}">Không tồn tại đơn hàng nào đang chờ xác nhận</td>
                        </tr>
                    @endif
                </tbody>
            </table>
...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      $("#waiting-accepted").addClass('active');
  });
</script>
@stop
