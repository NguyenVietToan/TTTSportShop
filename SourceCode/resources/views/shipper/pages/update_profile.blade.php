...
<section class="content">
    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 col-sm-push-2 col-md-push-3">
        ...
        <form action="{{ route('shipper.postEditInfo') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="email" placeholder="Nhập địa chỉ email" value="{{ old('email', isset($shipper) ? $shipper->email : null) }}" />
            </div>

            <div class="form-group">
                <label>Họ tên <span class="asterisk">*</span></label>
                <input type="text" class="form-control" name="name" placeholder="Nhập họ tên thành viên" value="{{ old('name', isset($shipper) ? $shipper->name : null) }}" />
            </div>

            <div class="form-group">
                <label>Ảnh đại diện hiện tại</label>
                <div id="img_current">
                    <img src="{{ asset('resources/upload/images/member/'.$shipper->id.'/'.$shipper->image) }}" alt="" class="img_current">
                    <input type="hidden" name="img_current" value="{{ $shipper->image }}" />
                </div>
                <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="identity_card" placeholder="Nhập số chứng minh thư nhân dân" value="{{ old('identity_card', isset($shipper) ? $shipper->identity_card : null) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12" style="padding: 0;">
                    <input type="text" style="margin: 7px 0 15px;" class="form-control" id="" name="address" value="{{ old('address', isset($shipper) ? $shipper->address : null) }}">
                </div>
            </div>
            ...
            <button type="button" class="btn btn-default functionButton" onclick = "window.location = '{{ route('shipper.getProfile') }}'">Quay lại</button>
        <form>
    </div>
</section>
