...
<section class="content">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 0">
        <a href="{{ URL::route('admin.largebanner.getAdd') }}" class="pull-right btn btn-default addItem"> Thêm banner lớn</a>
    </div>
    ...
    <form action="{{ route('admin.largebanner.postDelete') }}" method="POST" role="form">
        ...
        <div class="paginate pull-right">@include('pagination.paging', ['paginator' => $large_banners])</div>
    </form>
</section>
