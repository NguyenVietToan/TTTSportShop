...
<section class="content">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 0">
        <a href="{{ URL::route('admin.newscate.getAdd') }}" class="pull-right btn btn-default addItem"> Thêm loại tin</a>
    </div>
    ...
    <form action="{{ route('admin.newscate.postDelete') }}" method="POST" role="form">
        ...
        <button type="submit" class="btn btn-default" style="background: #337ab7; border-color: #337ab7; color:#fff;" onclick="return confirm('Bạn có chắc là muốn xóa các loại tin đã chọn không?')">Xóa</button>

        <div class="paginate pull-right">@include('pagination.paging', ['paginator' => $newscates])</div>
    </form>
</section>
